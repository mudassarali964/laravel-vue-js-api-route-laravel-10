...
``` bash
# clone the repo
$ git clone https://github.com/mudassarali964/laravel-vue-js-api-route-laravel-10.git my-project
...
4. Create database
``` bash
$ sudo -u postgres createdb laravel_vue
```
...
Basically we are using the Vite mixin. Whenever do some styling/script/component changes,
